...
namespaces=$(timeout 5 kubectl get namespaces --no-headers -o custom-columns=NAME:.metadata.name --request-timeout 5 || echo "Timeout:_check_connectivity_or_auth_against_cluster")
